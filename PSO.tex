...
\vspace*{1cm}
	...
	\begin{figure}[htbp]
    \begin{center}
    	\includegraphics[scale=0.3]{imagens-pso/particle-swarm-optimization-particles-0.png}
    	\includegraphics[scale=0.3]{imagens-pso/particle-swarm-optimization-particles-02.png}
    	\includegraphics[scale=0.3]{imagens-pso/particle-swarm-optimization-particles-03.png}
    	\includegraphics[scale=0.3]{imagens-pso/particle-swarm-optimization-particles-04.png}
